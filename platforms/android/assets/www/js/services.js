...
.factory('sharedFilterService', [function(){
	...
	var obj = {};
    obj.str = "http://moeza.xyz/food_menu.php";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	...
	obj.getUrl=function(){
		if(obj.sort!="" && obj.category!=""){
			obj.str="http://moeza.xyz/food_menu.php?category="+obj.category+"&sort="+obj.sort;
		}
		else if(obj.category!="" ){
			obj.str="http://moeza.xyz/food_menu.php?category="+obj.category;
		}
		else if(obj.sort!=""){  
			obj.str="http://moeza.xyz/food_menu.php?sort="+obj.sort;
		}
		return obj.str;
	};
	return obj;
